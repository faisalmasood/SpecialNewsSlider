...
export default class PropertyFieldPicturePickerHost extends React.Component<IPropertyFieldPicturePickerHostProps, IPropertyFieldPicturePickerHostState> {
  ...
  constructor(props: IPropertyFieldPicturePickerHostProps) {
    super(props);
    if (props.allowedFileExtensions !== undefined || props.allowedFileExtensions !== null ||
      (props.allowedFileExtensions !== undefined && props.allowedFileExtensions !== null && props.allowedFileExtensions.trim() === '')) {
      //REM props.allowedFileExtensions = this.allowedFileExtensions;
    }
            ...
            <tr>
              ...
              <td style={{ width: '64px' }}>
                <table style={{ width: '100%', borderSpacing: 0 }}>
                  <tbody>
                    <tr>
                      <td><IconButton disabled={(this.props.disabled !== undefined && this.props.disabled === true)} iconProps={{ iconName: 'FolderSearch' }} onClick={this.onOpenPanel} /></td>
                      <td><IconButton disabled={(this.props.disabled !== undefined && this.props.disabled === true) || this.state.selectedImage === undefined || this.state.selectedImage === null || (this.state.selectedImage !== undefined && this.state.selectedImage !== null && this.state.selectedImage.trim() === '')} iconProps={{ iconName: 'Delete' }} onClick={this.onEraseButton} /></td>
                    </tr>
                  </tbody>
                </table>
              </td>
